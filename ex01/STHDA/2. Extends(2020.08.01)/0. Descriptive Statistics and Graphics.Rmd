...
```{r chunk_25, echo=TRUE, fig.height=3.5, fig.width=2.5, message=FALSE, warning=FALSE, include=TRUE}
...
```{r chunk_26, echo=TRUE, fig.height=3.5, fig.width=2.5, message=FALSE, warning=FALSE, include=TRUE}
...
```{r chunk_27, echo=TRUE, fig.height=3.5, fig.width=2.5, message=FALSE, warning=FALSE, include=TRUE}
